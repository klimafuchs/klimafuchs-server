...
var grammar = {
    ...
    {"name": "template$ebnf$3", "symbols": ["template$ebnf$3", (lexer.has("word") ? {type: "word"} : word)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template$ebnf$4$subexpression$1$ebnf$1", "symbols": []},
    {"name": "template$ebnf$4$subexpression$1$ebnf$1", "symbols": ["template$ebnf$4$subexpression$1$ebnf$1", "ws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template$ebnf$4$subexpression$1", "symbols": [(lexer.has("delim") ? {type: "delim"} : delim), "template$ebnf$4$subexpression$1$ebnf$1", "templateValue"]},
    {"name": "template$ebnf$4", "symbols": ["template$ebnf$4$subexpression$1"]},
    {"name": "template$ebnf$4$subexpression$2$ebnf$1", "symbols": []},
    {"name": "template$ebnf$4$subexpression$2$ebnf$1", "symbols": ["template$ebnf$4$subexpression$2$ebnf$1", "ws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template$ebnf$4$subexpression$2", "symbols": [(lexer.has("delim") ? {type: "delim"} : delim), "template$ebnf$4$subexpression$2$ebnf$1", "templateValue"]},
    {"name": "template$ebnf$4", "symbols": ["template$ebnf$4", "template$ebnf$4$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template$ebnf$5", "symbols": []},
    {"name": "template$ebnf$5", "symbols": ["template$ebnf$5", "ws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template", "symbols": [(lexer.has("open") ? {type: "open"} : open), "template$ebnf$1", "templateName", "template$ebnf$2", "template$ebnf$3", "template$ebnf$4", "template$ebnf$5", (lexer.has("close") ? {type: "close"} : close)]},
